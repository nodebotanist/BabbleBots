...
module.exports = {
  ...
  loadComponentDefinitions: function(build, platform){
    ...
    build.components.forEach(function(component){
      ...
      result[component.type] = componentDefinition;
    });
  ...
  checkPins: function(build, platform, componentDefinitions){
    ...
    build.components.forEach(function(component){
        ...
        var componentDefinition = componentDefinitions[component.type];
        for(pin in componentDefinition.pins){
            ...
            if(componentDefinition.pins.hasOwnProperty(pin)){
                ...
                if(platform.pins[buildPin].indexOf(componentDefinition.pins[pin]) === -1){
